...
function setGender(gender)    
    ...
    TriggerEvent("mauirand",currentArmour)
...
local barberShops = {
	...
	[8] = { coords = vec3(108.65,-1305.9,28.77) },
    [9] = { coords = vec3(2517.04,-344.88,101.89) },
    [10] = { coords = vec3(-1382.62,-637.04,30.31) },
    [11] = { coords = vec3(251.48,-3154.1,-0.19) },
    [12] = { coords = vec3(-1987.71,-501.78,20.73) },
    [13] = { coords = vec3(-2676.05,3706.04,9.97) },
    [14] = { coords = vec3(-1517.55,847.71,181.81) },
    [15] = { coords = vec3(-2179.21,3154.38,32.81) },
    [16] = { coords = vec3(-2619.56,1711.53,146.32) },
    [17] = { coords = vec3(1180.08,136.28,80.96) },
    [18] = { coords = vec3(148.98,-771.52,50.13) },
    [19] = { coords = vec3(-2592.83,1907.53,163.71) },
}
...
local barberChairs = {
    ...
    [7] = {
	 ...
	 [8] = {
        { coords = vec3(107.82,-1305.8,28.77), h = 29.46, offset = vec3(-0.04, -0.68, 0.0) },   
    
    },
    [9] = {
        { coords = vec3(2517.04,-344.88,101.89), h = 36.86, offset = vec3(-0.04, -0.68, 0.0) },   
    
    },

    [10] = {
        { coords = vec3(-1382.62,-637.04,30.31), h = 45.36, offset = vec3(-0.04, -0.68, 0.0) },   
    
    },
    [11] = {
        { coords = vec3(251.48,-3154.1,-0.19), h = 280.63, offset = vec3(-0.04, -0.68, 0.0) },   
    
    },
    [12] = {
        { coords = vec3(-1987.71,-501.78,20.73), h = 274.97, offset = vec3(-0.04, -0.68, 0.0) },   
    
    },

    [13] = {
        { coords = vec3(-2676.05,3706.04,9.97), h = 17.01, offset = vec3(-0.04, -0.68, 0.0) },   
    
    }, 

    [14] = {
        { coords = vec3(-1517.55,847.71,181.81), h = 133.01, offset = vec3(-0.04, -0.68, 0.0) },   
    
    }, 

    [15] = {
        { coords = vec3(-2179.21,3154.38,32.81), h = 59.53, offset = vec3(-0.04, -0.68, 0.0) },   
    
    }, 

    [16] = {
        { coords = vec3(-2619.56,1711.53,146.32), h = 201.26, offset = vec3(-0.04, -0.68, 0.0) },   
    
    }, 

    [17] = {
        { coords = vec3(1180.08,136.29,80.88), h = 320.32, offset = vec3(-0.04, -0.68, 0.0) },   
    
    }, 

    
    [18] = {
        { coords = vec3(148.98,-771.52,50.13), h = 59, offset = vec3(-0.04, -0.68, 0.0) },   
    }, 

    [19] = {
        { coords = vec3(-2592.83,1907.53,163.71), h = 59, offset = vec3(-0.04, -0.68, 0.0) },   
    }, 
...
function drawChairMarkers()
    ...
    for k,v in ipairs(barberChairs[barberId]) do
        ...
        if not HasStreamedTextureDictLoaded("blip3d") then
            ...
            DrawMarker(9, x,y,z,0,0,0,90.0,0.0,0,0.6,0.6,0,255, 255, 255, 255,false, true, 1, false, "blip3d", "blip-salao", false)
        end
    end
end
