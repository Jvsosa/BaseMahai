...
local tattooShops = {
	...
	[7] = { coords = vec3(-2678.58,3698.66,6.17), h = 328.82 },
	[8] = { coords = vec3(-1515.21,844.0,181.81), h = 113.39 },
	[9] = { coords = vec3(1182.77,132.76,80.74), h = 280.63 },
}
...
function drawMarkers()
	...
	if not HasStreamedTextureDictLoaded("blip3d") then
		...
		DrawMarker(9, x,y,z,0,0,0,90.0,0.0,0,0.6,0.6,0,255, 255, 255, 255,false, true, 1, false, "blip3d", "blip-tattoos", false)
	end
end
