...
local bennysLocations = {
	["1"] = {
		blip = {['x'] = 127.26, ['y'] = -3037.95, ['z'] = 6.72 },
		heading = 90.71,
		permission = "Mechanic"
	},

	["2"] = {
		blip = {['x'] = 126.98, ['y'] = -3031.1, ['z'] = 6.72 },
		heading = 90.71,
		permission = "Mechanic"
	},

	["3"] = {
		blip = {['x'] = 126.89, ['y'] = -3024.03, ['z'] = 6.727 },
		heading = 90.71,
		permission = "Mechanic"
	},

	["4"] = {
		blip = {['x'] = 142.11, ['y'] = -3019.97, ['z'] = 6.72 },
		heading = 2.80,
		permission = "Mechanic"
	},
	...
	["55"] = {
		blip = {['x'] = 142.98, ['y'] = -2995.89, ['z'] = 7.68 },
		heading = 87.80,
		permission = "Mechanic"
	},

	["5"] = {
		blip = {['x'] = -3190.73, ['y'] = 820.79, ['z'] = 8.93 },
		heading = 124.73,
		permission = "Admin"
	},

	["6"] = {
		blip = { ['x'] =2122.2, ['y'] = 4572.61, ['z'] = 30.2 },
		heading = 328.82,
		permission = "Admin"
	},

	["7"] = {
		blip = { ['x'] = -320.74, ['y'] = -731.88, ['z'] = 27.4 },
		heading = 249,
		permission = "Escola"
	},
	...
	["8"] = {
		blip = { ['x'] = -309.61, ['y'] = -736.15, ['z'] = 27.4 },
		heading = 68,
		permission = "Escola"
	},
	
	["9"] = {
		blip = { ['x'] = 3912.11, ['y'] = -4711.49, ['z'] = 4.26 },
		heading = 291.97,
		permission = "Admin"
	},
				...
				for k,v in pairs(bennysLocations) do
					...
					if distance <= 10 then
						...
						if not HasStreamedTextureDictLoaded("blip3d") then
							...
							DrawMarker(9, v.blip['x'],v.blip['y'],v.blip['z'],0,0,0,90.0,0.0,0,0.6,0.6,0,255, 255, 255, 255,false, true, 1, false, "blip3d", "psd_blips_mec", false)
						end
						if distance <= 2.5 then
							msec = 3
							if IsControlJustPressed(0,38) and vSERVER.checkPermission(v["permission"])  then
								...
								SetVehicleModKit(vehicle,0)
								SetEntityCoords(vehicle,v.blip['x'],v.blip['y'],v.blip['z'])
...
-- 								end
-- 								else
-- 								DrawMarker(9, v["pos"],0,0,0,90.0,0.0,0,0.6,0.6,0,255, 255, 255, 255,false, true, 1, false, "blip3d", "pvp_blip", false)
-- 							end

-- 							if IsControlJustPressed(1,38) and vSERVER.checkPermission(v["permission"]) and distance <= 2.5 then
