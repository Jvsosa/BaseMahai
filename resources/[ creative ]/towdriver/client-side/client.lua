...
AddEventHandler("towdriver:Toggle",function(id)
	if inService then
		...
		--TriggerEvent("NotifyPush",{ code = 20, imagem = "carro", title = "Registro de Veículo", criminal = "Aguardando reboque." x = vehRescue[serviceLocate][spawnCoords][1], y = vehRescue[serviceLocate][spawnCoords][2], z = vehRescue[serviceLocate][spawnCoords][3], name = "Aguardando reboque", blipColor = 2 })
	end
