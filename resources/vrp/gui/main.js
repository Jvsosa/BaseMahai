		...
		if (data["identity"] !== undefined){
			if (data["identity"] == false){
				...
				if (data["mode"] == "identity"){
					$("#identityDiv").html(`
						<div class="identityLeft">Passaporte<br><r>${data["id"]}</div>
						<div class="identityRight">VIP<br><r>${data["premium"]}</div>
						...
						<div class="identityLeft">Miami Coins<br><r>${format(data["gemas"])}</div>
