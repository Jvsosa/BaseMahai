...
function vRP.getDiscordPlayer(user_id)
	local source2 = vRP.userSource(user_id)
	local steam2 = vRP.getIdentities(source2)
	local discord = vRP.query("accounts/getInfos",{ steam = steam2 })
	if discord[1] then
